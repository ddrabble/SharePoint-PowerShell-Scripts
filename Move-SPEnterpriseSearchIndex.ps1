...
#Move-SPEnterpriseSearchIndex -SearchServiceName "Search Service Application" -Server "MEMWINSHPAPP1" -IndexLocation "E:\Search"
#Move-SPEnterpriseSearchIndex -SearchServiceName "Search Service Application" -Server "MEMWINSHPAPP2" -IndexLocation "E:\Search"
#Move-SPEnterpriseSearchIndex -SearchServiceName "Search Service Application" -Server "MEMWINSHPWEB1" -IndexLocation "E:\Search"
#Move-SPEnterpriseSearchIndex -SearchServiceName "Search Service Application" -Server "MEMWINSHPWEB2" -IndexLocation "E:\Search"
